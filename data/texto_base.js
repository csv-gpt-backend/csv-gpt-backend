...
La “Prueba Habilidades Emocionales” es una prueba psicométrica diseñada para evaluar 3 conjuntos de habilidades integrados por 14 subpruebas 2 independien- tes.
...
• Formato electrónico: La prueba se presenta en un formato digital, lo que fa- cilita su administración y permite un procesamiento más eficiente de los resultados.
...
La posición relativa del evaluado dentro del grupo de referencia 3 se indica utilizan- do percentiles 4.
La presentación de los resultados se realiza a través de una curva de distribución de frecuen- cias de Gauss 5 en percentiles y se divide en tres rangos: por desarrollar, por fortalecer y por enri- quecer.
Estos rangos representan la distribución de los puntajes en un gráfico que tiene forma acampanada y simétrica.
Tanto en el ámbito educativo como en el empresarial cada subprueba es barema- da de acuerdo con el grado académico en el que se encuentra la persona.
